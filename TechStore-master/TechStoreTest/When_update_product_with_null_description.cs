...
namespace TechStoreBlazorApp.Shared.TechStoreTest
{
    ...
    public class When_update_product_with_null_description
    {
        ...
        Establish context = () => {
            product = new Product(5, "none", "none", "none", null, "1234");
        ...
        It should_have_a_specific_reason = () => exception.Message.ShouldContain("Value cannot be null. (Parameter 'Value 'Description' cannot be null.')");
    }
}
