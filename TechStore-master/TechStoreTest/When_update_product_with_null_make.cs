...
namespace TechStoreBlazorApp.Shared.TechStoreTest
{
    ...
    public class When_update_product_with_null_make
    {
        ...
        Establish context = () => {
            product = new Product(5, null, "none", "none", "none", "1234");
        ...
        It should_have_a_specific_reason = () => exception.Message.ShouldContain("Value cannot be null. (Parameter 'Value 'Make' cannot be null.')");
    }
}
